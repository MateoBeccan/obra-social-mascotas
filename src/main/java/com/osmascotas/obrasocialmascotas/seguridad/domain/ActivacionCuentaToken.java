...
@Entity
@Table(name = "activacion_cuenta_token")
public class ActivacionCuentaToken {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "activacion_cuenta_token_id")
    private Long id;
    ...
    @JoinColumn(
            name = "usuario_id",
            nullable = false,
            foreignKey = @ForeignKey(name = "fk_activacion_cuenta_token_usuario")
    )
    ...
    protected ActivacionCuentaToken() {
        // Requerido por JPA.
    }

    public ActivacionCuentaToken(
            Usuario usuario,
            String tokenHash,
